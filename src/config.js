const config = {
	...
	background: {
		"pc": {   //pc端
			...
			"datainfo": {
				...
				"url": "/img/wallpaper/dynamic/尼尔：机械纪元 团队/Nier-Automata-Team.mp4",     //当然，也可填写网络地址或壁纸api，如随机PC壁纸api："url":"https://t.mwm.moe/pc"
			},
		},
		"mobile": {   //移动端
			"type": "video",
	...
	projectcards: [
		...
		{ go: "🎨 前往", img: "/img/SectorImg/TestProjectSector.jpg", title: "简单的自动化测试", subtitle: "web自动化登录测试案例", text: "小白都可以看懂的测试案例", url: "/projects/Project-Test/test.html", show: false },
