const config = {
	...
	projectcards: [
		...
		{ go: "🗃 前往", img: "/img/sunshine.jpg", title: "Project 5测试", subtitle: "知识分享模块测试", text: "If you see this line, I've managed to get your attention.", url: "/projects/Project5test/test.html", show: false },
